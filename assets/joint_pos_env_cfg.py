...
from .threefingers import THREEFINGERS_CFG  # isort: skip
...
class UR5CubeLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        ...
        # Set Franka as robot
        self.scene.robot = THREEFINGERS_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        self.actions.gripper_action = mdp.BinaryJointPositionActionCfg(
            asset_name="robot",
            joint_names=["joint.*"],
            close_command_expr={"joint1": -0.05,"joint2": 0.05,"joint3": 0.05},
            open_command_expr={"joint.*": 0.0},
        )
        # Set the body name for the end effector
        self.commands.object_pose.body_name = "body_hand"

        # Set Cube as object
        self.scene.object = RigidObjectCfg(
            prim_path="{ENV_REGEX_NS}/Object",
            init_state=RigidObjectCfg.InitialStateCfg(pos=(0.7, 0.0, 0.25), rot=[1, 0, 0, 0]),
            spawn=UsdFileCfg(
